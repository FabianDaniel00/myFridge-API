...
const { addToUsedGroceries } = require("../recipes/addToUsedGroceries.js");
const { getDataForChart } = require("../recipes/getDataForChart.js");
...
addToUsedGroceries(recipesRouter, pool, verifyJWT);
getDataForChart(recipesRouter, pool, verifyJWT);
